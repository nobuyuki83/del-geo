...
impl Headers {
    pub fn get(&self, idx: usize) -> Option<(&str, &str)> {
        [
            ...
            ("mat3_array_of_rows.h", include_str!("mat3_array_of_rows.h")),
            ("mat4_col_major.h", include_str!("mat4_col_major.h")),
            ("prism.h", include_str!("prism.h")),
            ("pyramid.h", include_str!("pyramid.h")),
            ("quaternion.h", include_str!("quaternion.h")),
            ("tet.h", include_str!("tet.h")),
